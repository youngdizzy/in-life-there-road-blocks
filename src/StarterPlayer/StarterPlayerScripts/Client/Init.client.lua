...
local DiscoveryLogUI = require(script.Parent.DiscoveryLogUI)
local GoalsUI = require(script.Parent.GoalsUI)
...
DiscoveryLogUI.Init(playerGui)
GoalsUI.Init(playerGui)
